...
export const CARD_COMPONENT_MAP = {
    ...
    section: 'selfstudy-card-activity',
    activity: 'selfstudy-card-activity'
};
...
export default [
    ...
    createComponentCard('section', {}),
    createComponentCard('activity', {})
];
...
export const CARD_MENU = [
    {
        ...
        {
            label: 'Activity',
            icon: 'koenig/selfstudy-card-type-activity',
            iconClass: 'kg-card-type-native',
            matches: ['activity'],
            type: 'card',
            replaceArg: 'activity'
...
export const NO_SECTION_CARD_MENU = CARD_MENU.map(menu => Object.assign({}, menu, {
    items: menu.items.filter(item => item.replaceArg !== 'activity')
}));